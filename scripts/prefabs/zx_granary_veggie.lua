...
local function fn()
    ...
    inst.AnimState:SetBank("zx_granary_veggie") 
    inst.AnimState:SetBuild("zx_granary_veggie")
    ...
    inst.components.container:WidgetSetup("zx_granary_veggie")
...
return Prefab("zx_granary_veggie", fn, assets, prefabs),
